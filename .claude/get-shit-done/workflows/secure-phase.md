...
```
Agent(
  prompt="Read C:/Users/Mahod/Desktop/Projects/FitnessMaxxing/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/Mahod/Desktop/Projects/FitnessMaxxing/.claude/get-shit-done/templates/SECURITY.md`
