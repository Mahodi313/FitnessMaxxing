...
```bash
INIT=$(node "C:/Users/Mahod/Desktop/Projects/FitnessMaxxing/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/Users/Mahod/Desktop/Projects/FitnessMaxxing/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
