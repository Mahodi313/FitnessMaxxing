...
The keys live in `.claude/settings.json` (project) or `C:/Users/Mahod/Desktop/Projects/FitnessMaxxing/.claude/settings.json` (global) — **not** in `.planning/config.json`:
