...
- [x] **PR-02**: A PR set is marked with a trophy in the active-workout set list
- [x] **PR-03**: A PR shows a celebration banner (with gradient-sweep animation) during the workout
